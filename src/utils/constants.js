...
export const spacialString = ['userJson', 'deptId', 'costCategory', 'amount', 'loanSum', 'month', 'incomeCategory','office', 'name', 'signingDate', 'stopDate', 'money', 'project', 'deptId1'];
...
export const incomeInvoiceStatus = [
//   {
//   key: '0',
//   value: '草稿'
// },
